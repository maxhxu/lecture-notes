...
$V_{cc}$ is ``common collector voltage'' which is high voltage ($5V$) in this course. You need to \textit{explicitly} connect the output to exactly one of $V_{cc}$ or ground for it to be high or low (exclusive) respectively. Otherwise, the result is indeterminate. This is what an AND gate looks like at the transistor-level:
