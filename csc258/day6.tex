...
We draw a diagram, representing the transitions that we want.

\subsection*{Step 2: FSM Table}

\subsection*{Step 3: Flip flop Assignments}

The na\"{i}ve way of doing things is quite dangerous, and we need to find a safer flip flop assignment. We may use a `diagonal' pattern to avoid this problem.

\subsection*{Step 4: Redraw State Table}

Replace each of our states with the numerical values (rows of the table) that we have chosen in step 3.
