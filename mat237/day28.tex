...
\begin{definition}
    ...
    \item $f : U \to \mathbb{R}$ be a $C^1$ function
        \item $(a, b) \in U$, $a \in \mathbb{R}^n, b \in \mathbb{R}^k$, with $f(a, b) = 0$
    \end{itemize}
    The equation $f(x, y) = 0$ locally defines $y$ as a $C^1$ function of $x$ near $(a, b)$, if
    \begin{itemize}
...
\item (For non-linear systems with $n + k$ variables and $k$ equations) Check if $k$ variables can be expressed as a $C^1$ function of the other $n$ variables: \\
    The motivation for doing this comes later.
\end{enumerate}   
