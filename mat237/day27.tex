...
Diffeomorphisms are particularly nice, and there are lots of powerful theorems about diffeomorphisms. This motivates us trying to see when a function is a diffeomorphism.
...
\noindent Combining with \ref{thm:iftr}, we get that this is an if and only if relationship.
